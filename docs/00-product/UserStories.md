...
| **REQ-SRV-07**       | P0   | Server derives and stores match **winner** from captured outcome data.                                                          | US-2       | House rule: FB **or** first tower **or** CS≥100; store at persist; fail if neither/ambiguous. See [DEC-001](../05-knowledge/Decisions.md#dec-001--custom-duel-win-judgement). |
